...
class ActionPlanningAgent:
    ...
    def extract_steps_from_prompt(self, prompt):
        ...
        # Getting the response from the OpenAI API and extracting the response text
        response_text = response.choices[0].message.content

        # Process response: extract individual action steps, drop empty or irrelevant lines
        steps = []
